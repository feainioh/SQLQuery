    ...
    public class PCI1020
    {
        ...
        **************************************************************************/
        ...
        public struct PCI1020_PARA_RR3      
        {
            ...
            public UInt32 XIN1;			// 外部停止信号XIN1的电平状态 1：高电平 0：低电平    ---本项目用作X轴伺服Server ON/OFF信号
            ...
            public UInt32 YIN1;			// 外部输入信号YIN1的电平状态  1：高电平 0：低电平   ---本项目用作Y轴伺服Server ON/OFF信号
        ...
        public static extern bool PCI1020_InitDeviceInt(IntPtr hDevice, IntPtr hEventInt); // 初始化中断
                [DllImport("PCI1020.DLL")]
        public static extern Int32 PCI1020_GetDeviceIntCount(IntPtr hDevice);  // 在中断初始化后，用它取得中断服务程序产生的次数
                [DllImport("PCI1020.DLL")]
