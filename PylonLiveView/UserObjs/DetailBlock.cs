    ...
    public partial class DetailBlock : UserControl
    {
            ...
            set 
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        {
                            pictureBox1.Image = fordisplay;
                            button_result.ForeColor = Color.BurlyWood;
                            m_BorderColor = Color.BurlyWood;
                            //刷新边界
        ...
        */
        ...
        private void pictureBox1_Paint(object sender, PaintEventArgs e)
        {
            ...
            pen.Width = 3;
            e.Graphics.DrawRectangle(pen, 2, 2
                , this.pictureBox1.Width - 3*2
                , this.pictureBox1.Height - 3*2);
                ...
                BeginInvoke(new Action(() =>
                    {
                        ...
                        {
                            button_result.Text = "";
                            button_result.ForeColor = Color.Gray;
        ...
        {
            magnify mag = new magnify((Bitmap)m_bitmap.Clone());
            mag.Text = "放大镜  POINT:" + m_PcsNo_Mapping;
            mag.setResult(HalconResult, m_BorderColor);
            mag.ShowDialog();
        }
